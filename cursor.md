...
Bookspace is a web extension for Zen Browser that organizes bookmarks by workspace using folders.

## Development Notes

- Extension uses Manifest V2 (compatible with Firefox/Zen Browser)
- Main files:
  - `background.js` - Core extension logic, workspace switching, bookmark management
  - `popup.html` / `popup.js` - Extension popup UI
  - `manifest.json` - Extension manifest

## Common Tasks

- Testing workspace transitions
- Verifying container detection
- Checking bookmark organization

## Reminders

- This is ALPHA software (version 0.0.1)
...
description: Automatically update cursor.md file based on recent code changes
---

# Update cursor.md File

## Current cursor.md State
@cursor.md
...
Based on the current cursor.md content and all the git analysis above, create an updated cursor.md file that:
...
Intelligently update these cursor.md sections:
...
- **Maintain structure**: Follow existing cursor.md organization
- **Add timestamps**: Note when major updates were made

## 5. Output Format
Provide the complete updated cursor.md content, organized as:
